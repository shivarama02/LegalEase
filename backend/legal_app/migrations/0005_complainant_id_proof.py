...
def add_missing_columns(apps, schema_editor):
    ...
    add_column(Complaint._meta.db_table, 'complainant_id_proof', "varchar(255) NOT NULL DEFAULT ''")
    add_column(ComplaintDraft._meta.db_table, 'complainant_id_proof', "varchar(255) NOT NULL DEFAULT ''")


class Migration(migrations.Migration):

    dependencies = [
        ('legal_app', '0004_respondent_phone'),
    ]
