          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-5 space-y-5">
              ...
              {selected.section_text && (
                <div><p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Section Text</p><pre className="font-mono text-[13px] text-slate-700 whitespace-pre-wrap leading-relaxed bg-slate-50 rounded-xl p-4  text-left">{selected.section_text}</pre></div>
              )}
              {detail ? (
                <>
