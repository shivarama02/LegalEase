            ...
            <div className="flex-1 max-w-7xl mx-auto p-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div className="lg:col-span-4 grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* Card templates */}
                        <LawCategoryCard onClick={()=>navigate('/laws/ipc')} colorBg="bg-red-100 text-red-700" icon={<Scale className="h-6 w-6" />} title="Criminal Law" count="45 laws" desc="Laws dealing with crimes and punishment" tags={['Theft','Assault','Drug Offenses','+1 more']} />
                        <LawCategoryCard onClick={()=>navigate('/laws/civil')} colorBg="bg-blue-100 text-blue-700" icon={<FileText className="h-6 w-6" />} title="Civil Law" count="32 laws" desc="Private disputes between individuals or organizations" tags={['Contract Disputes','Property Rights','Torts','+1 more']} />
                        <LawCategoryCard onClick={()=>navigate('/laws/family')} colorBg="bg-pink-100 text-pink-700" icon={<Heart className="h-6 w-6" />} title="Family Law" count="28 laws" desc="Legal matters involving family relationships" tags={['Divorce','Child Custody','Adoption','+1 more']} />
                        <LawCategoryCard onClick={()=>navigate('/laws/labour')} colorBg="bg-green-100 text-green-700" icon={<Briefcase className="h-6 w-6" />} title="Employment Law" count="38 laws" desc="Rights and obligations in workplace relationships" tags={['Wrongful Termination','Discrimination','Wage Laws','+1 more']} />
                        <LawCategoryCard onClick={()=>navigate('/laws/property')} colorBg="bg-yellow-100 text-yellow-700" icon={<Home className="h-6 w-6" />} title="Property Law" count="41 laws" desc="Ownership and use of real estate and personal property" tags={['Real Estate','Landlord-Tenant','Property Rights','+1 more']} />
                        <LawCategoryCard onClick={()=>navigate('/laws/consumer')} colorBg="bg-purple-100 text-purple-700" icon={<Users className="h-6 w-6" />} title="Consumer Law" count="25 laws" desc="Protection of consumer rights and fair trade practices" tags={['Product Liability','False Advertising','Warranty','+1 more']} />
                    </div>
